  ...
  <div class="row">
    <div class="col-md-12">
     ...
     <div class="card card-primary">
        ...
        @foreach ($oPartidas as $oChave)

          @if ($sChave != '' && $oChave->chave != $sChave)
                  </tbody>
                </table>
              </div>
            </div>
          ...
          @if ($oChave->chave != $sChave )
            <div class="card card-<?php echo $aCores[$i];?>">
              <div class="card-header">
                <span class="card-title" style="display: block ruby;">CHAVE {{$oChave->chave}}</span>
              </div>
              <div class="card-body">
          ...
          @endif        
                  <tr role="row" class="odd">
                    <td class="sorting_1">{{ $oChave->dupla }}</td>
                    <td>{{ $oChave->vitorias }}</td>
                    <td>{{ $oChave->derrotas }}</td>
                    <td>{{ $oChave->pontos }}</td>
                    <td>@if ($oChave->pontos > 0 ) 
